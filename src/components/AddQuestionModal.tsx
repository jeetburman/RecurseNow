...
export default function AddQuestionModal({ onClose, onAdd, editQuestion, onEdit }: Props) {
  ...
  const Label = ({ children }: { children: React.ReactNode }) => (
    <label className="text-xs font-medium block" style={{ color: "var(--text-3)", marginBottom: "0.5rem" }}>
      {children}
    </label>
  );
  ...
  return (
    <div
      ...
      style={{ background: "rgba(8,8,12,0.82)", backdropFilter: "blur(6px)" }}
    >
      <div
        className="w-full fade-up my-auto"
        style={{
          maxWidth: "480px",
          padding: "2rem",
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          ...
          <div style={{ display: "flex", gap: "0.75rem" }}>
            <div style={{ width: "80px", flexShrink: 0 }}>
              <Label>No.</Label>
              <input type="text" placeholder="42" value={form.questionNumber}
          ...
          <div>
            ...
            <input type="text" placeholder="Two Sum" value={form.name}
        ...
        <div style={{ display: "flex", gap: "0.75rem", marginTop: "1.5rem" }}>
          ...
          <button onClick={handleSubmit}
            ...
            className="text-sm font-semibold transition-all disabled:opacity-40 flex items-center justify-center"
            style={{
              flex: 1, padding: "10px",
              borderRadius: "var(--radius-md)",
